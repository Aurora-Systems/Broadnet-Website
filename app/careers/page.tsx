...
export default function Careers() {
  ...
  const send_application = (e: FormEvent) => {
    ...
    set_loading(true);
    emailjs
      .sendForm("service_ap5fhkw", "template_uq8okit", form.current, {
  ...
  return (
    <div className="min-vh-75 container d-flex align-items-center justify-content-center">
      <div>
        <h1 className="display-1 fw-bold">JOIN BROADNET</h1>
        <p>
          We are big on passion, express yourself, make decisions that matter!
        </p>
