    ...
    <nav className="bg-white rounded mt-3 z-1 navbar navbar-expand-lg bg-white position-sticky top-0 pt-3 w-100 ">
      <div className="container">
        ...
        <div className={`collapse navbar-collapse ${isOpen ? "show" : ""}`}>
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <div className="dropdown">
                <button
                  type="button"
                  className="bg-white btn-none border-0 ms-0 nav-link"
                ...
                <ul className="dropdown-menu">
                  <li className="pointer">
                    <a
                      ...
                      onClick={() =>
                        handleNavigation(page_links.services.broadtrak)
                      }
                    >
                      BroadTrak
                    </a>
                  ...
                  <li className="pointer">
                    <a
                      className="dropdown-item"
                      onClick={() =>
                        handleNavigation(page_links.services.intactsys)
                      }
                    >
                      Intactsys
                    </a>
                  ...
                  <li className="pointer">
                    <a
                      className="dropdown-item"
                      onClick={() =>
                        handleNavigation(page_links.services.fortis_comm)
                      }
                    >
                      Fortis-Comm
                    </a>
          ...
          <Link href={page_links.contact} onClick={closeNavbar}>
            <button className="btn p-btn rounded w-sm-100">
              Ready To Build?
            </button>
          </Link>
        </div>
  ...
  return (
    <div className="row bg-white text-dark p-3">
      ...
      <div className="col-sm">
        ...
        <p>
          <Link href={page_links.services.broadtrak}>BroadTrak</Link>
        </p>
        <p>
          <Link href={page_links.services.intactsys}>Intactsys</Link>
        </p>
        <p>
          <Link href={page_links.services.fortis_comm}>Fortis-Comm</Link>
        </p>
      </div>
      <div className="col-sm">
        <div className="mb-3">
        ...
        <p>
          <Link href={page_links.careers}>Careers</Link>
        </p>
        <p>
          <Link href={page_links.blog}>Blog</Link>
        </p>
        <p>
          <Link href={page_links.contact}>Contact us</Link>
        </p>
      </div>
